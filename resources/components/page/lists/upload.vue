<template>
   <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Upload Lists</h5>
        </div>
        <div class="card-body">
            ...
            <form action="/api/v1/lists/upload" method="POST" class="dropzone dz-clickable" :id="`dropzone_${this._uid}`">
    ...
    export default {
        mounted() {
            const dropzone = new Dropzone(`#dropzone_${this._uid}`, {
                ...
                maxFilesize: 100,
                acceptedFiles: 'text/csv, text/plain, application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/CDFV2',

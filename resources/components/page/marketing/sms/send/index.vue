<template>
   <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">SMS Blasts</h5>
        ...
        <div class="card-body">
            <router-link class="btn btn-sm btn-success" to="/marketing/sms/send/new">New</router-link>
        </div>
    ...
    export default {
        ...
        mounted() {
            this.table = jQuery(`#data-table-${this._uid}`).DataTable({
                ...
                ajax: `${window.location.origin}/api/v1/marketing/sms/blasts/`,
                processing: true,
                serverSide: true,
                order: [[ 0, "desc" ]],
                select: {
                ...
                columns:[
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<a href="#/marketing/sms/send/${row[0]}">${data}</a>`;
                        }
                    }
                ],
            });
                ...
                await swal({
                    ...
                    if (result.value) {
                        ...
                        for (let i = 0; i < apiIds.length; i++) {
                            ...
                            const path = `/marketing/sms/blasts/${apiId}`;
                            try {

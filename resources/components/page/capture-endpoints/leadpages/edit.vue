   ...
   <div class="card">
        ...
        <div class="card-body">
            ...
            <div v-if="!loading && !error && hash" class="alert alert-info">
                ...
                <input type="url" class="form-control" readonly :value="`${window.location.origin}/capture/leadpages/${hash}`"  />
            </div>
...
<script>
    export default {
        data() {
            return {
                fieldToAdd: null,
                title: 'LeadPages Capture Endpoint',
                name: null,
                mapping: {
                    fname: {
                        leadfield: 'fname',
        ...
        async mounted() {
            this.title = ('undefined' === typeof(this.$route.params.id)) ? 'Create an LeadPages Capture Endpoint' : `Edit LeadPages Capture Endpoint #${this.$route.params.id}`;
        ...
        methods: {
            ...
            async submitForm() {
                swal({
                    title: 'Processing',
                    text: 'Saving the LeadPages Capture Endpoint. Please wait.',
                    type: 'info',
                ...
                try {
                    ...
                    await swal({
                        title: 'Success',
                        text: 'Saved LeadPages Capture Endpoint Successfully.',
                        type: 'success',
                        buttonsStyling: false,
                    ...
                    if ('undefined' === typeof(this.$route.params.id)) {
                        this.$router.push(`/capture/endpoints/leadpages/${response.data.body.id}`);
                    }
                    swal.close();
                } catch (error) {
                    swal.close();

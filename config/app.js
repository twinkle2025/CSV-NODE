...
module.exports = {
  ...
  */
  ...
  name: 'Bastion',
  environment: Env.get('NODE_ENV', 'local'),
  /*
  |--------------------------------------------------------------------------
  | App Key
  |--------------------------------------------------------------------------
  ...
  */
  ...
  maxJobs: Env.get('MAX_CONCURRENT_JOBS', 2),
  batchSize: Env.get('IMPORT_BATCH_SIZE', 50),
  bucketSize: Env.get('IMPORT_BUCKET_SIZE', 100),
  maxBeforeAutoDump: Env.get('AUTO_DUMP_MAX', 100),
}
